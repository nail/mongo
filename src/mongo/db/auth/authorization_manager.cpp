...
namespace {
    ...
    MONGO_INITIALIZER(AuthorizationSystemRoles)(InitializerContext* context) {
        ...
        // Cluster admin role
        clusterAdminRoleReadActions.addAction(ActionType::backupStatus);
        ...
        clusterAdminRoleReadActions.addAction(ActionType::pluginList);
        ...
        clusterAdminRoleReadActions.addAction(ActionType::showLiveTransactions);
        clusterAdminRoleReadActions.addAction(ActionType::showPendingLockRequests);
