...
namespace mongo {
    ...
    public:
        ...
        void incMatch( const BSONObj& pk );

        bool wouldIncMatch( const BSONObj& pk ) const;
     ...
     *
     * A MultiCursor is backed by one BasicCursor or IndexCursor at a time and forwards calls for
